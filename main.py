        ...
        <div id="pricingModal" class="modal-overlay">
            <div class="modal-content" style="max-width: 750px;">
                ...
                <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap:12px; margin-top:15px;">
                    ...
                    <div class="price-card">
                        <h3 style="color:#38bdf8; margin-top:0; font-size:15px;">المحَدودة</h3>
...
@app.post("/humanize")
async def humanize_text(text: str = Form(...), tone: str = Form("صحفي سلس وممتع"),
                        length: str = Form("نفس الطول الأصلي")):
...
{text}"""
    ...
    payload = {
        ...
        "messages": [
            {"role": "system",
             "content": "أنت محرر وصحفي بشري محترف وخبير في إزالة أنماط الذكاء الاصطناعي وجعل النصوص تبدو بشرية 100%."},
